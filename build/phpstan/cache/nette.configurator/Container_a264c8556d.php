...
class Container_a264c8556d extends _PHPStan_3d4486d07\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_a264c8556d $container)
			{
	...
	public function createService070(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			$this->getService('071'),
			[],
			['analyseAndScan' => ['/home/vagrant/code/project-crafter/database/migrations'], 'analyse' => []]
		);
	}
	...
	public function createServiceContainer(): Container_a264c8556d
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludes_analyse' => [],
			'excludePaths' => ['analyseAndScan' => ['/home/vagrant/code/project-crafter/database/migrations'], 'analyse' => []],
			'level' => 8,
			'paths' => [
			...
			'earlyTerminatingFunctionCalls' => ['rd', 'dd'],
